        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde sus inicios, las organizaciones han desempeñado un papel central en la vida de las personas, sirviendo como vehículos para alcanzar objetivos comunes en un entorno en constante cambio. En esta unidad, profundizaremos en la teoría organizacional y en las relaciones que las organizaciones establecen con su entorno y entre sí, explorando conceptos clave como el análisis del ambiente externo, las herramientas de diagnóstico y las estrategias interorganizacionales. Este enfoque nos permitirá entender cómo las dinámicas internas y externas influyen en el desempeño organizacional, y cómo aplicar estos conocimientos en la toma de decisiones estratégicas. 
              
              p #[b ¡Prepárese para descubrir cómo las organizaciones logran adaptarse y prosperar en escenarios complejos y volátiles!]
